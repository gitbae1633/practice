...
public class ProductRepository {
	...
	public boolean insert(ProductVo vo,UserVo authUser) {
		Map<String, Object> map = Map.of("vo",vo,"user",authUser);
	...
	public int updateByCode(String productCode, ProductVo vo,UserVo authUser) {
		Map<String, Object> map = Map.of("pcode",productCode,"vo",vo,"user",authUser);
